...
const SHUFFLE_CITY_DATASETS = [
    ...
    `United States, New York, #f39c12, Financial Capital of the World, Home to Wall Street and the NYSE, false
United Kingdom, London, #3498db, Global Finance Hub, Centre of European and global banking, false
Japan, Tokyo, #e74c3c, Asia's Largest Financial Centre, World's third largest stock exchange, false
China, Shanghai, #2ecc71, China's Commercial Capital, Largest city in the world's second economy, false
Germany, Frankfurt, #9b59b6, Europe's Banking Capital, Home to the European Central Bank, false
Singapore, Singapore, #1abc9c, Asia's Gateway, One of the world's top four financial centres, false
Switzerland, Zurich, #e67e22, Global Private Banking Hub, Home to UBS and Credit Suisse headquarters, false
Hong Kong, Hong Kong, #e91e63, Asia's Financial Centre, Bridge between China and global markets, false
United Arab Emirates, Dubai, #00bcd4, Middle East Finance Hub, Fastest growing financial centre globally, false
France, Paris, #8bc34a, European Business Capital, Home to the Paris Bourse and major multinationals, false`,

    // 2 — Historic World Capitals
    `Italy, Rome, #e74c3c, The Eternal City, Capital of the ancient Roman Empire, false
Greece, Athens, #3498db, Birthplace of Democracy, One of the world's oldest cities, false
Egypt, Cairo, #f39c12, City of a Thousand Minarets, Built beside the ancient pyramids of Giza, false
China, Beijing, #9b59b6, China's Imperial Capital, Home to the Forbidden City and Tiananmen Square, false
India, Delhi, #e67e22, Capital of India, One of the world's most historically layered cities, false
Turkey, Istanbul, #2ecc71, City on Two Continents, Straddles both Europe and Asia, false
Iran, Tehran, #1abc9c, Persian Capital, Gateway to Iran's ancient civilisation, false
Peru, Lima, #e91e63, City of Kings, Founded by conquistadors on the Pacific coast, false
Mexico, Mexico City, #00bcd4, Aztec to Modern Metropolis, Built on the ruins of Tenochtitlan, false
Japan, Kyoto, #8bc34a, Japan's Ancient Capital, Former imperial seat for over a thousand years, false`,
...
function shuffleCSV() {
    ...
    const datasets = mode === 'city' ? SHUFFLE_CITY_DATASETS : SHUFFLE_POLYGON_DATASETS;
    const picked = datasets[Math.floor(Math.random() * datasets.length)];
    input.value = picked.trim();

    // Brief visual flash on the textarea to confirm the change
